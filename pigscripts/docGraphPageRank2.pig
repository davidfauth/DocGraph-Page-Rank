%default INPUT_PATH 's3n://medgraph/refer.2011.csv'
%default NUM_USERS_OUTPUT_PATH 's3n://DataOut/DocGraph/NumUsers'
%default PAGERANKS_OUTPUT_PATH 's3n://DataOut/DocGraph/InitialPageRanks'
