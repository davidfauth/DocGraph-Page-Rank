...
# Script Parameters
NUM_TOP_USERS      = 750 # The number of users with with the highest pagerank returned in the final result.
...
def run_pagerank():
    """
    Calculates pageranks for MedGraph Data users.
   ...
   # Postprocesing step:
    ...
    postprocess_bound = postprocess.bind({
		...
		"NUCC_CODES_INPUT": NUCC_CODES_INPUT,
		"NPI_DATA_INPUT": NPI_DATA_INPUT,
        "TOP_N": NUM_TOP_USERS,
